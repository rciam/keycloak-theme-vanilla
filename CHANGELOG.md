...
### Fixed
- Account Console routing and navigation issues 

## [6.2.10] - 2026-08-31

### Fixed
- Disable non editable multivalued fields in profile page
- Error handling in linked accounts page 
- Hide unlink action in linked accounts page if disabled

## [6.2.9] - 2026-08-28

### Fixed
- Fix ThemeConfig initialization problem when Keycloak start up

## [6.2.8] - 2026-08-26

### Fixed
- Fix error exception during user registration

## [6.2.7] - 2026-08-25

### Fixed
- Fix sporadically occurring problem while Keycloak start up

## [6.2.6] - 2026-07-22

### Fixed
- Fix problem while Keycloak start up and create realm
...
- Increased page size in Account Linking page

## [6.0.11] - 2026-03-16

### Fixed

- Fix in already login IdPs
- Added contacts in Applications Page

## [6.0.10] - 2026-03-11

### Fixed

- For promoted and already login IdPs list, return only enabled, Account linking only equal to false and Hide on login page equal to false

## [6.0.9] - 2026-03-10

### Fixed

- Dynamic Header Logo in Account Console
...
- Removed Group Page
- Replaced Keycloak logo with RCIAM

## [6.0.7] - 2026-03-04

### Fixed

- Reintroduced Username in Profile Page
- Fixed Update Profile Description
...
- Fixed inputs on Profile Page

## [6.0.4] - 2026-02-26

### Fixed

- Change review profile page [RCIAM-537](https://tts.grnet.gr/jira/browse/RCIAM-537)
...
- Support for Keycloak 26.5

## [5.10.0] - 2025-05-16

### Added

- Add Username in Otp-login
...
- Improve MFA login screen in Keycloak
