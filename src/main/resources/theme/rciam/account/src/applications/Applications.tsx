...
import { ContinueCancelModal, label } from "@keycloak/keycloak-ui-shared";
import {
  Button,
  DataList,
  DataListCell,
...
export const Applications = () => {
  ...
  // ✅ IMPORTANT: useEnvironment from @keycloak/keycloak-account-ui
                  ...
                  <>
                    <DescriptionListGroup>
                      ...
                      {application.consent.grantedScopes.map((scope) => (
                        <DescriptionListDescription key={`scope${scope.id}`}>
                          <CheckIcon />{" "}
                          {/* add translation mapping if you want scope display */}
                          {scope.displayText ?? scope.name}
                        </DescriptionListDescription>
                      ))}
                    </DescriptionListGroup>
                    ...
                    {application.logoUri && (
                      <DescriptionListGroup>
                        ...
                        <DescriptionListDescription>
                          <img src={application.logoUri} alt={t("logo")} />
                        </DescriptionListDescription>
                      </DescriptionListGroup>
                    )}
